 ...
 */
public class FragmentPartTime extends Fragment implements SortListener{
    ...
    public static FragmentPartTime newInstance(String param1, String param2) {
        FragmentPartTime fragment = new FragmentPartTime();
